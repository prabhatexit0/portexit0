  ...
  return (
    <AboutContainer>
      ...
      <p>Final year undergraduate student with expertise in JavaScript, TypeScript, React.js and related frameworks.
        ...
        For more information, please refer to my <a target="_blank" className="font-bold cursor-pointer border-[1px] px-1 border-gray-700 rounded-md hover:bg-gray-900 text-gray-300" href={RESUME_LINK} rel="noreferrer">resume</a>.</p>
    </AboutContainer>
  )
}
