...
const linkButtonStyle = 'p-1 left-5 w-32 top-5 font-bold hover:bg-emerald-500 border-b-2 border-emerald-500 transition-all easi-in-out'
const blogsButtonStyle = 'p-1 left-5 w-32 top-5 font-bold cursor-not-allowed transition-all easi-in-out'
